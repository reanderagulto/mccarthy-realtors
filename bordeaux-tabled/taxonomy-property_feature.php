			...
			<div id="content" class="<?php echo $queried_object->taxonomy; ?>">
				...
				<ul class="grid">
					<?php
						...
						$current_term = get_term_by( 'name',single_cat_title( '', false ), 'property_feature' );
						$args = array( 
									'post_type'					=> 'listing',
					...
					<li>
						<div class="prop-img-wrap">
								<a class="<?php echo ( $sold_property == 'yes' )?'pop-sold':''; ?> listing-item" data-listing-id="<?php echo get_the_ID( ); ?>" href="<?php echo ( $sold_property == 'yes' )?'#pop-light':get_the_permalink( ); ?>">
									<?php 
					...
					<li>
						...
						<div class="prop-det">
							...
							<p class="prop-desc">
								...
								<a class="view-details <?php echo ( $sold_property == 'yes' )?'pop-sold':''; ?> listing-item" data-listing-id="<?php echo get_the_ID( ); ?>" href="<?php echo ( $sold_property == 'yes' )?'#pop-light':get_the_permalink( ); ?>" >Details</a>
						</div>								
					</li>
					<?php	
							} //
